...
const FeatureList: FeatureItem[] = [
  ...
  },
  {
    ...
    description: (
      <>
        Plug into any design system with themeOverrides. Light/dark mode, custom
        colors, and full styling control via props.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Full type safety out of the box. Exported types for props, theme
